const CONFIG = {
  ...
  COMMERCE_TEXT_CENTER_TITLE: '所有款式', // 中间产品区块标题
  COMMERCE_TEXT_CENTER_DESCRIPTION:
    '原创潮流元素健身服装品牌，独立设计显大显宽版型', // 中间产品区块文字描述
  COMMERCE_TEXT_CENTER_CATEGORY_TITLE: '款式分类', // 左侧产品分类标题
  COMMERCE_TEXT_FOOTER_TITLE: '联系我们', // COMMERCE主题页脚文案标题；按Shift+Enter键可以换行
  COMMERCE_TEXT_FOOTER_MENU_1: '款式列表', // COMMERCE主题页脚左侧菜单标题1
